		...
		<template v-if="showFlag">
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='false' :sortable='false' :width="80"
					...
					<el-table-column :resizable='false' :sortable='false' :width="50"
						prop="xingbie"
						label="性别">
						<template slot-scope="scope">
							{{scope.row.xingbie}}
					...
					<el-table-column :resizable='false' :sortable='false' :width="60"
						prop="nianling"
						label="年龄">
						<template slot-scope="scope">
							{{scope.row.nianling}}
