<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="店铺名称" prop="dianpumingcheng">
					<el-input v-model="ruleForm.dianpumingcheng" placeholder="店铺名称" clearable  :readonly="ro.dianpumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="店铺名称" prop="dianpumingcheng">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="职位" prop="zhiwei">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gerenjianjie = this.ruleForm.gerenjianjie.replace(reg,'../../../springbootpavyhdan/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
