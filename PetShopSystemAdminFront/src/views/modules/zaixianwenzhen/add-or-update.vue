<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="问诊编号" prop="wenzhenbianhao">
					<el-input v-model="ruleForm.wenzhenbianhao" placeholder="问诊编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.wenzhenbianhao" label="问诊编号" prop="wenzhenbianhao">
					<el-input v-model="ruleForm.wenzhenbianhao" placeholder="问诊编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="姓名" prop="yishixingming">
					<el-input v-model="ruleForm.yishixingming" placeholder="姓名" clearable  :readonly="ro.yishixingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="姓名" prop="yishixingming">
					<el-input v-model="ruleForm.yishixingming" placeholder="姓名" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="宠物昵称" prop="chongwunicheng">
					<el-input v-model="ruleForm.chongwunicheng" placeholder="宠物昵称" clearable  :readonly="ro.chongwunicheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="宠物昵称" prop="chongwunicheng">
					<el-input v-model="ruleForm.chongwunicheng" placeholder="宠物昵称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="问诊时间" prop="wenzhenshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.wenzhenshijian" label="问诊时间" prop="wenzhenshijian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="问诊症状" prop="wenzhenzhengzhuang">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.wenzhenzhengzhuang" label="问诊症状" prop="wenzhenzhengzhuang">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.wenzhenzhengzhuang}}</span>
				</el-form-item>
