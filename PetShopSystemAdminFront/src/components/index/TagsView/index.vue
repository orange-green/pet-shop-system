<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"4px 30px","margin":"00","borderColor":"#385d86","background":"linear-gradient(#f2f2f2, #e5e5e5)","borderWidth":"0","width":"100%","borderStyle":"solid","height":"34px"}'>
