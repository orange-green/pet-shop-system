<template>
  <div
    ...
    <el-form ref="form" :model="form" :rules="rules" class="add-update-preview" label-width="80px">
      <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"none"}' label="联系人"
                    prop="name">
        <el-input v-model="form.name" placeholder="联系人"></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"none"}' label="手机号码"
                    prop="phone">
        <el-input v-model="form.phone" placeholder="手机号码"></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"none"}' label="默认地址">
        <el-radio-group v-model="form.isdefault">
          <el-radio label="是"></el-radio>
          <el-radio label="否"></el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"none"}' label="地址"
                    prop="address">
      ...
      <el-form-item :style='{"padding":"0","margin":"0"}'>
        <el-button
            ...
            type="primary" @click="onSubmit('form')">添加
        </el-button>
        <el-button v-if="!isBuy"
    ...
    <el-dialog id="myMapDialog" :visible.sync="dialogVisible" title="请选择收货地址" top="5vh" width="500px">
      <baidu-map :center="center" :scroll-wheel-zoom="true" :zoom="zoom" class="map" @click="getClickInfo"
                 @ready="onBaiduMapReady">
        <bm-view style="width: 100%; height: 100%;"/>
        <bm-marker :dragging="true" :position="{lng: center.lng, lat: center.lat}" animation="BMAP_ANIMATION_BOUNCE"/>
        <bm-geolocation
            :autoLocation="true"
            :showAddressBar="true"
      ...
      <div slot="footer">
        <el-input v-model="address" placeholder="请选择或填写收货地址" style="margin-bottom: 15px;"></el-input>
