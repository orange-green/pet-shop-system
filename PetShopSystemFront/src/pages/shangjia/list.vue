...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"1px solid #E0E0E0","padding":"10px","margin":"0 auto","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 20px)","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"0 5px 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#000","display":"inline-block"}'>负责人：</div>
	  ...
	  <el-button v-if="btnAuth('shangjia','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 10px 0","outline":"none","color":"#fff","borderRadius":"0","background":"#3B2E7E","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/shangjiaAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"100%","padding":"20px 0","margin":"0 0 10px","background":"#fff"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0 10px","flexWrap":"wrap","background":"#fff","display":"block","height":"auto"}'>
			<div :style='{"border":"1px solid #E0E0E0","padding":"45px 30px 15px","margin":"0","flexWrap":"wrap","background":"none","display":"inline-block","width":"25%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"10px 0","color":"#444","textAlign":"center","width":"100%","lineHeight":"1.5","fontSize":"20px","fontWeight":"bold","order":"3"}' class="name ">{{item.dianpumingcheng}}</div>
				<div :style='{"padding":"10px 0","color":"#444","textAlign":"center","width":"100%","lineHeight":"1.5","fontSize":"20px","fontWeight":"bold","order":"3"}' class="name ">{{item.fuzeren}}</div>
