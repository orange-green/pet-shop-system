<template>
	<div :style='{"width":"80%","margin":"0 auto","position":"relative","background":"#fff"}'>
	<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 5px 10px 0","outline":"none","color":"#fff","borderRadius":"20px","background":"#6353B4","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="warning" size="mini" @click="backClick" class="el-icon-back">返回</el-button>
	<div :style='{"width":"100%","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)"}'>
		<div :style='{"width":"100%","height":"auto"}'>
			<div :style='{"margin":"20px 0 10px","color":"#000","textAlign":"center","background":"none","fontSize":"22px","lineHeight":"54px","fontWeight":"bold"}'>新闻资讯</div>
		</div>
		<div :style='{"width":"100%","padding":"0 20px","position":"relative","flexWrap":"wrap","display":"flex"}'>
			...
			<div class="operate" :style='{"width":"50%","padding":"10px 20px","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
				<div @click="zanClick" :style='{"border":"1px solid #D8D8D8","padding":"0 15px","margin":"0 10px 0 0","alignItems":"center","justifyContent":"center","display":"flex"}'>
					<span class="icon iconfont icon-guanzhu-zhihui" :style='{"margin":"0 5px 0 0","lineHeight":"30px","fontSize":"14px","color":"#f00"}'></span>
				...
				<div @click="collectClick" :style='{"border":"1px solid #D8D8D8","padding":"0 15px","alignItems":"center","justifyContent":"center","display":"flex"}'>
					<span class="icon iconfont icon-shoucang10" :style='{"margin":"0 5px 0 0","lineHeight":"30px","fontSize":"14px","color":"#f87b01"}'></span>
					<span :style='{"color":"#333","lineHeight":"30px","fontSize":"14px"}'>{{collectType?'取消收藏':'收藏'}}</span>
				</div>
			</div>
			
			<div :style='{"width":"100%","lineHeight":"1.5","fontSize":"15px","color":"#000","height":"auto"}' class="content-detail" v-html="detail.content"></div>
		</div>
		<!-- option -->
		<div :style='{"width":"100%","padding":"20px","justifyContent":"center","display":"flex","height":"auto"}'>
		  <div :style='{"padding":"0 10px","margin":"0 10px","lineHeight":"30px","fontSize":"14px","color":"#fff","background":"#474747"}' @click="prepDetailClick">上一篇：prev</div>
		  <div :style='{"padding":"0 10px","margin":"0 10px","lineHeight":"30px","fontSize":"14px","color":"#fff","background":"#3B2E7E"}' @click="nextDetailClick">下一篇：next</div>
		</div>

		<!-- 热门文章 -->
		<div class="hot" :style='{"boxShadow":"none","padding":"0 20px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
		  <div :style='{"color":"#000","textAlign":"left","background":"none","width":"100%","lineHeight":"44px","fontSize":"22px","fontWeight":"bold"}'>热门文章</div>
		  <div :style='{"width":"100%","padding":"0 0 5px 0","background":"#fff","display":"flex","height":"auto"}'>
		    <div v-for="item in hotList" :key="item.id" :style='{"width":"20%","padding":"5px 5px 0","background":"#fff","flex":"1","height":"auto"}' @click="toDetail(item.id)">
		      <img :style='{"width":"100%","objectFit":"cover","display":"block","height":"120px"}' :src="baseUrl + item.picture" alt="">
		      <div :style='{"padding":"5px 0","lineHeight":"1.5","fontSize":"16px","color":"#000","textAlign":"center"}'>{{ item.title }}</div>
		      <div :style='{"padding":"0 5px","lineHeight":"1.5","fontSize":"12px","color":"#4d4d4d","textAlign":"center"}'>{{item.addtime}}</div>
		    </div>
		  </div>
		</div>
		<!-- 推荐文章 -->
		<div class="news" :style='{"width":"100%","padding":"0 20px","background":"#fff","height":"auto"}'>
		  <div :style='{"padding":"0","color":"#000","background":"none","width":"100%","lineHeight":"44px","fontSize":"22px","fontWeight":"bold"}'>推荐文章</div>
		  <div :style='{"width":"100%","padding":"5px 0 0","background":"#fff","justifyContent":"space-between","display":"flex","height":"auto"}'>
