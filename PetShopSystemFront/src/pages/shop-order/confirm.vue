<template>
  <div
    ...
    <div :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"20px 0","color":"#000","textAlign":"center","background":"none","width":"100%","fontSize":"22px","lineHeight":"54px","fontWeight":"bold"}'
         class="section-title">
      确认{{ totalPrice > 0 ? '下单' : '预订' }}
    </div>
        ...
        <template slot-scope="scope">
          <div class="shangpin">
            <el-image
                ...
                fit="fill"
                style="width: 100px; height: 100px;flex: 1"></el-image>
    ...
    <div style="width: 100%;padding: 12px;box-sizing: border-box;display: flex;align-items: center;">
      ...
      <el-input v-model="remark" placeholder="备注" style="width: calc(100% - 80px);" type="textarea"></el-input>
    </div>
    <div v-if="seat!=1 && tableData.length > 0" class="buy">
    ...
    <div v-if="seat==1 && tableData.length > 0" class="buy">
      ...
      <template v-else>
        <span v-if="totalPrice>0" style="color: red;margin-right: 10px;font-weight: 700;">总价：<span
            :style='{"fontSize":"12px"}'>￥</span>{{ totalPrice }}</span>
